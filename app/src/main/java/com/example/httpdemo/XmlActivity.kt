...
class XmlActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        mBinding.buttonXmlPull.setOnClickListener { sendHttp("http://10.32.151.137:8080/xml/get_data.xml") }

        mBinding.buttonXmlSax.setOnClickListener { }
    }
     ...
     */
    private fun sendHttp(stringUrl: String = "http://www.baidu.com") {
        thread {
            try {
                //创建网络连接客户端对象
                ...
                runOnUiThread { mBinding.htmlText.text = parseXMLPull(bodyString) }
            } catch (e: Exception) {
                e.printStackTrace()
            }
        }
